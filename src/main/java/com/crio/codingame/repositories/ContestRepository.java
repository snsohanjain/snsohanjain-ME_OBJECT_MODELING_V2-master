...
public class ContestRepository implements IContestRepository {
    ...
    public boolean existsById(String id) {
        ...
        if(contestMap.containsKey(id)) return true;
        return false;
    }
    ...
    public void delete(Contest entity) {
        // TODO Auto-generated method stub
        if(contestMap.containsKey(entity.getId())) contestMap.remove(entity.getId());
    ...
    public void deleteById(String id) {
        // TODO Auto-generated method stub
        if(contestMap.containsKey(id)) contestMap.remove(id);
