...
public class QuestionRepository implements IQuestionRepository {
    ...
    public void delete(Question entity) {
        // TODO Auto-generated method stub
        if(questionMap.containsKey(entity.getId())) questionMap.remove(entity.getId());
    ...
    public void deleteById(String id) {
        // TODO Auto-generated method stub
        if(questionMap.containsKey(id)) questionMap.remove(id);
    ...
    public List<Question> findAllQuestionLevelWise(Level level) {
        return questionMap.values().stream().filter(c -> c.getLevel().equals(level))
